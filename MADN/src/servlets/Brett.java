...
public class Brett {
	...
	//-----Wuerfel---------
	s+="<div id='dice'>";
	if(Index.getGame().getWuerfelZahl()==null){
		s+="<img src='Bilder/dice0.png'>";
	}else if(Index.getGame().getWuerfelZahl()==6){
		s+="<img src='Bilder/dice6.png'>";
	}else if(Index.getGame().getWuerfelZahl()==5){
		s+="<img src='Bilder/dice5.png'>";
	}else if(Index.getGame().getWuerfelZahl()==4){
		s+="<img src='Bilder/dice4.png'>";
	}else if(Index.getGame().getWuerfelZahl()==3){
		s+="<img src='Bilder/dice3.png'>";
	}else if(Index.getGame().getWuerfelZahl()==2){
		s+="<img src='Bilder/dice2.png'>";
	}else if(Index.getGame().getWuerfelZahl()==1){
	...
	if((Index.getGame().getWuerfelZahl()==null||Index.getGame().getWuerfelZahl()==6)){
		...
		s+="<form action='Wuerfeln' method='post'>";
		if(Index.getGame().ermittleSpielerAmZugFarbe().equals(Index.getGame().gibFarbeSession())&&Index.getGame().ermittleGewinner()==false&&press==true){
			s+="<input  id='wurf' type = 'submit' value = 'Würfeln' name='wurfNormal'>";
		}else{
			s+="<input disabled id='wurf' type = 'submit' value = 'Würfeln'>";
		}
...
//			fig="<a href='/MADNWeb/Laufen0'>";
			fig="<a href='/MADNWeb/Laufen0.jsp'>";
		}
...
//			fig="<a href='/MADNWeb/Laufen1'>";
			fig="<a href='/MADNWeb/Laufen1.jsp'>";
		}
...
//			fig="<a href='/MADNWeb/Laufen2'>";
			fig="<a href='/MADNWeb/Laufen2.jsp'>";
		}
...
//			fig="<a href='/MADNWeb/Laufen3'>";
			fig="<a href='/MADNWeb/Laufen3.jsp'>";
		}
		return fig;
	}
